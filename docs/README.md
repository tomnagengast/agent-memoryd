...
| [Config](./config.md) | Understand `config.json`, `AGENT_MEMORYD_HOME`, and persisted resources. |
...
| [Daemon](./daemon.md) | Run transcript and git-event ingestion. |
| [Git hooks](./git-hooks.md) | Install hook templates that enqueue git events. |
